				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							<input type="hidden" name="business" value="rizalramadhan087@gmail.com.com">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/PTDutaInsanPerdana/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/PTDutaInsanPerdana/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://localhost/PTDutaInsanPerdana/cancel.php"/>
